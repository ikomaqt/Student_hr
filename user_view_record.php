...
$stmt = $conn->prepare("SELECT lrn FROM users WHERE id = ?");
...
// Fetch student information using LRN
$stmt = $conn->prepare("SELECT si.*, s.section_name as section_name 
        ...
        <form id="student-form" method="POST">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <label>Sex: <select name="sex" readonly>
                        ...
                        <?php foreach ($immunization_records as $immunization): ?>
                            <div class="vaccine-entry">
                                <div style="align-items: center;" class="add_vaccine">
                                    <input type="text" style="width: 180px;" name="vaccine_name[]" value="<?php echo htmlspecialchars($immunization['vaccine_name']); ?>" readonly>
                                    <input type="text" style="width: 180px;" name="dose[]" value="<?php echo htmlspecialchars($immunization['dose']); ?>" readonly>
                                    <input type="date" style="width: 180px;" name="date_given[]" value="<?php echo htmlspecialchars($immunization['date_given']); ?>" readonly>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php else: ?>
                ...
                <div class="form-group">
                    ...
                    <label>Remarks: 
                        <input type="text" name="remarks" 
                            value="<?php echo (isset($physicalExam['remarks']) && ($physicalExam['remarks'] !== '0' && $physicalExam['remarks'] !== 0)) ? htmlspecialchars($physicalExam['remarks']) : ''; ?>" 
                            readonly>
                    </label>
                </div>
                <div class="form-group">
                    <label>Examined By: 
                        <input type="text" name="examined_by" 
